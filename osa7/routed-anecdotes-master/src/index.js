...
const CreateNew = ({ content, author, info, addNew }) => {
  const history = useHistory()
  const inputContent = Object.assign({}, content)
  const inputAuthor = Object.assign({}, author)
  const inputInfo = Object.assign({}, info)
    ...
    <Router>
      <div>
        ...
        <Switch>
          ...
          <Route path="/create">
            <CreateNew content={content} author={author} info={info} addNew={addNew} />
          </Route>
          <Route path="/">
